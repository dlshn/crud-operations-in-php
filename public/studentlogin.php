...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // check POST method form submiton
    ...
    if($row = mysqli_fetch_assoc($result)) {// "fetch_assoc" fetches row of the query result
        ...
        if(password_verify($password, $row["password"])) {
            ...
            $_SESSION['id'] = $id;           
            header("Location: studenthome.php"); // redirect to studenthome page
            exit();
...
<body>
    <div class="container" style="max-width: 500px;">
        ...
        <form action="studentlogin.php" method="POST">
            ...
            <p class="text-center mt-3">Don't have an account? <a href="studentregister.php">Register here</a></p>
